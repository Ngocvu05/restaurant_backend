...
/**
 * Redis Configuration for 2-Tier Caching
...
public class RedisConfig {
    ...
    /**
     * RedisTemplate for manual caching operations
     * Used by CustomCacheServiceImpl
     */
    @Bean
    @Primary
    public RedisTemplate<String, Object> redisTemplate(RedisConnectionFactory connectionFactory) {
        log.info("Configuring RedisTemplate<String, Object>");
    ...
    /**
     * Redis Cache Manager for L2 cache
     * Used by @Cacheable annotations and CustomCacheServiceImpl
     */
    ...
    public CacheManager redisCacheManager(RedisConnectionFactory connectionFactory) {
        ...
        log.info("Redis Cache Manager (L2) configured successfully");
        return cacheManager;
    }
