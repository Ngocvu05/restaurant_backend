...
-- Insert sample users
INSERT INTO users (id, username, password, full_name, email, phone_number, address, role_id, created_at)
VALUES (1, 'john_doe', 'password123', 'John Doe', 'john@example.com', '1234567890', '123 Main St', 2, NOW()),
...
-- Insert dishes
INSERT INTO dishes (id, name, description, price, category, available)
VALUES (1, 'Pho', 'Vietnamese beef noodle soup', 50000.00, 'MAIN', true),
       (2, 'Spring Rolls', 'Fried spring rolls with pork', 30000.00, 'APPETIZER', true);

-- Insert bookings
INSERT INTO bookings (id, user_id, table_id, booking_time, number_of_guests, note, status, number_of_people)
VALUES (1, 1, 1, NOW(), 2, 'Birthday dinner', 'CONFIRMED', 2),
       (2, 2, 2, NOW(), 4, 'Meeting', 'PENDING', 4);

-- Insert booking_dishes
INSERT INTO booking_dishes (booking_id, dish_id)
VALUES (1, 1),
       (1, 2),
       (2, 2);

-- Insert order_history
INSERT INTO order_history (id, booking_id, dish_id, quantity, served, note, created_at, user_id, total_amount)
VALUES (1, 1, 1, 2, true, 'Extra beef', NOW(), 1, 100000.00),
       (2, 1, 2, 3, false, '', NOW(), 1, 90000.00);

-- Insert payments
INSERT INTO payments (id, booking_id, amount, payment_method, payment_time, status)
VALUES (1, 1, 190000.00, 'CASH', NOW(), 'PAID'),
