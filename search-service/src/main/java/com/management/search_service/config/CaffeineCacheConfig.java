...
/**
 * Caffeine Cache Configuration for Search Service
 * L1 (in-memory) cache for fast local access
 */
@Slf4j
@Configuration
public class CaffeineCacheConfig {
    ...
    public CacheManager caffeineCacheManager() {
        log.info("🔧 Configuring Caffeine Cache Manager (L1) for Search Service");
        ...
        // Pre-create cache names for search service
        cacheManager.setCacheNames(java.util.Arrays.asList(
                "dishes",      // Dish search results
                "search",      // General search cache
